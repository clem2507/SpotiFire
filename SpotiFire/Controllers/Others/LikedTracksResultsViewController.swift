//
//  LikedTracksResultsViewController.swift
//  SpotiFire
//
...
class LikedTracksResultsViewController: UIViewController {
    ...
    private var collectionView: UICollectionView = UICollectionView(
        ...
        return LikedTracksResultsViewController.createSectionLayout(section: sectionIndex)
        }
    )
    ...
    func update(with results: SearchResultsResponse) {
        self.likedTracksSection = [TrackCellViewModel]()
    ...
    private func configureModel(
        ...
        likedTracksSection.append(contentsOf: tracks.items.compactMap({
...
extension LikedTracksResultsViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if LikedTracksViewController.selectedItems.count > 4 {
            ...
            LikedTracksViewController.selectedItems[likedTracksSection[indexPath.row].id] = (likedTracksSection[indexPath.row].track_name, IndexPath(row: indexPath.row, section: 0))
        }
    }
